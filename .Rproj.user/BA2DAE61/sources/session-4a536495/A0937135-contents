...
county2020 <- read_csv("01_Daten/countypres_2000-2020.csv") %>% 
...
groups <- read_csv2("01_Daten/groups.csv") %>% 
...
ggsave(filename = "03_Grafiken/voters.png",
       plot = voters_fig,
       device = png,
       width = 13,
       height = 8)
...
issues <- read_csv2("01_Daten/issues.csv") %>% 
...
ggsave(filename = "03_Grafiken/issues.png",
       plot = issues_fig,
       device = png,
       width = 13,
       height = 8)
